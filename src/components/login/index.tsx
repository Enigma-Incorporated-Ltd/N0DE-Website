  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Loadout synced. Resume your campaign — manage your N0DE subscription, billing, and account settings."
        />
        <meta
          name="keywords"
          content="login, sign in, subscription management, billing, account access"
        />
      </Helmet>
      ...
      <div className="min-vh-100 bg-dark">
        ...
        <main className="flex-fill section-space-md-y">
            ...
            <div className="container">
              <div className="row g-5 align-items-center">
                ...
                <div className="col-12 col-lg-6 order-1 order-lg-2 text-center text-lg-start">
                  ...
                  >
                    <div
                      className="d-inline-flex align-items-center flex-wrap row-gap-2 column-gap-4 mb-4"
                      data-cue="fadeIn"
                    >
                    ...
                    <p
                      className="text-light text-opacity-75 mb-8"
                      data-cue="fadeIn"
                    >
                      Resume your campaign — manage plans, track billing, and
                      jump back into peak performance with N0DE.
                    </p>
                    ...
                    <div className="mb-8" data-cue="fadeIn">
                      <div className="d-flex align-items-center mb-4">
                        <div
                          className="bg-primary-gradient rounded-circle d-flex align-items-center justify-content-center me-3"
                    ...
                    {/* Stats */}
                    <div
                      className="bg-dark-gradient p-6 rounded-5"
                      data-cue="fadeIn"
                    >
          ...
          <section className="section-space-md-y">
            <div className="container">{/*<SecurityBadges />*/}</div>
          </section>
        </main>
