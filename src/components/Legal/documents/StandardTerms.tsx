const StandardTerms = () => {
  return (
    <div className="text-light-50">
      <h2 className="text-light mb-4">Standard Terms and Conditions</h2>
      
      <p className="mb-4">
        ENIGMA INCORPORATED LIMITED incorporated and registered in England and Wales with company number 12515127 
        whose registered office is at c/o Park Vale, 50 Sloane Avenue, London SW3 3DD, United Kingdom ("Enigma")
      </p>

      <h4 className="mb-3">1. DEFINITIONS AND INTERPRETATION</h4>
      <p className="mb-3">
        1.1) In these standard terms ("Standard Terms") including the Policies and any Schedules hereto, 
        except to the extent that the context otherwise requires, the following terms shall have the meanings set forth below:
      </p>
      
      <ul className="mb-4">
        <li className="mb-2">
          <strong>"Change Request"</strong> means as set out in clause 2.3;
        </li>
        <li className="mb-2">
          <strong>"Client"</strong> means you (an individual end user, users or entity on behalf of which these Standard Terms are accepted);
        </li>
        <li className="mb-2">
          <strong>"Confidential Information"</strong> means as set out in Schedule 2;
        </li>
        <li className="mb-2">
          <strong>"Consequential Loss"</strong> means indirect, incidental, special or consequential loss or damage (including loss of profits, loss of sales or business, loss of agreements or contracts, loss of anticipated savings, loss of or damage to goodwill, loss of use or corruption of software, data or information) suffered by a Party;
        </li>
        <li className="mb-2">
          <strong>"Deliverables"</strong> means the specific deliverables pursuant to the Services, as set out in the relevant Sales Forms;
        </li>
        <li className="mb-2">
          <strong>"Effective Date"</strong> means the earlier of: (i) the date on which the Client executes a Sales Form; or (ii) the date on which the Client first uses any product or service of Enigma;
        </li>
        <li className="mb-2">
          <strong>"Fees"</strong> has the meaning given in clause 4.1, including any such "Additional Fees", or as set out in the relevant Sales Forms;
        </li>
        <li className="mb-2">
          <strong>"Force Majeure"</strong> means as set out in clause 9.1;
        </li>
        <li className="mb-2">
          <strong>"Goods"</strong> means all equipment, materials, supplies, ancillary parts, accessories, components and other items purchased by the Client, from Enigma, pursuant to, and as identified in, a Sales Forms;
        </li>
        <li className="mb-2">
          <strong>"Group"</strong> means that undertaking, parent, holding, subsidiary and/or associated company from time to time and "member of its Group" shall be construed accordingly;
        </li>
        <li className="mb-2">
          <strong>"Intellectual Property Rights"</strong> is as set out in Schedule 2;
        </li>
        <li className="mb-2">
          <strong>"Liability"</strong> means any expense, cost, liability, loss, damage, claim, notice, entitlement, investigation, demand, proceeding or judgment (whether under statute, contract, equity, tort (including negligence), indemnity or otherwise), howsoever arising, whether direct or indirect and/or whether present, unascertained, future or contingent and whether involving a third party or a Party or otherwise;
        </li>
        <li className="mb-2">
          <strong>"Milestone"</strong> means each date for delivery as set out in the relevant Sales Forms;
        </li>
        <li className="mb-2">
          A <strong>"Party"</strong> or the <strong>"Parties"</strong> refer to Enigma and the Client;
        </li>
        <li className="mb-2">
          The <strong>"Policies"</strong> as amended are: Fair Use Policy, End User Policy, Privacy Policy, Software License Agreement, Cloud Storage Addendum and DMCA Policy;
        </li>
        <li className="mb-2">
          <strong>"Sales Forms"</strong> means a document, mutually agreed between the Parties from time to time which, among other matters, sets out specifically any (if applicable): (i) Services; (ii) Deliverables; (iii) Milestones; and (iv) Fees;
        </li>
        <li className="mb-2">
          <strong>"Services"</strong> means the services, software, features, products, Support and Goods to be supplied by Enigma to the Client pursuant to the relevant Sales Forms and these Standard Terms;
        </li>
        <li className="mb-2">
          <strong>"Specification"</strong> means the written technical description for the Deliverables as may be set out in the relevant Sales Forms, as may be amended from time to time with mutual written consent;
        </li>
        <li className="mb-2">
          <strong>"Term"</strong> means as defined in clause 6.1; and
        </li>
        <li className="mb-2">
          <strong>"Third-Party Licences"</strong> means as defined in clause 5.1.
        </li>
      </ul>

      <div className="mb-4">
        <p className="mb-3">1.2) In these Standard Terms, unless the context otherwise requires:</p>
        <ul className="mb-3">
          <li className="mb-2">References to "you" and "your" mean the Client or the individual end user accessing or using our Services;</li>
          <li className="mb-2">References to "we", "us", and "our" mean Enigma;</li>
          <li className="mb-2">References to clauses and schedules are to be construed as references to the clauses and schedules to these Standard Terms, including any Schedules;</li>
          <li className="mb-2">Words importing the singular include the plural and vice versa, words importing a gender include every gender;</li>
          <li className="mb-2">The term 'including' does not exclude anything not listed, and is understood to mean 'including without limitation';</li>
          <li className="mb-2">References to a person shall be construed as including references to an individual, firm, issuer, corporation, unincorporated body of persons or any state or any agency thereof;</li>
          <li className="mb-2">Any reference to a statutory provision shall include such provision and any regulations made in pursuance thereof as from time to time modified or re-enacted;</li>
          <li className="mb-2">The terms 'writing' or 'written' will, unless otherwise stated, include signatures being received via e-mail, if so made in accordance with clause 11.8;</li>
          <li className="mb-2">Headings are for convenience of reference only and shall not affect interpretation.</li>
        </ul>

        <p className="mb-3">1.3) References to Enigma herein shall include all of its Group and associated third parties from time to time.</p>
        
        <p className="mb-4">
          1.4) <strong>Order of Precedence:</strong> In the event of a conflict or inconsistency between these Standard Terms, any applicable Schedule, and any Sales Form, the following order of precedence shall apply (unless expressly stated otherwise): (a) the Sales Form; (b) the relevant Schedule; and (c) these Standard Terms.
        </p>
      </div>

      <h4 className="mb-3">2) APPOINTMENT AND SUPPLY OF SERVICES</h4>
      <p className="mb-3">
      ...
      <div className="mb-4 pl-4">
        <p className="mb-2">
          <strong>A)</strong> First, if the Client requires specific services, it will notify Enigma in writing setting out:
        </p>
        <ul className="mb-3 pl-4">
          <li className="mb-1">A specification of the desired services;</li>
          <li className="mb-1">The timeframe for delivery of the services, goods and any milestones or deliverables; and</li>
          <li className="mb-1">If applicable an indication of the Client's desired budget.</li>
        </ul>
        
        <p className="mb-2">
          <strong>B)</strong> Next, upon receipt of the notice from the Client pursuant to this clause 2.2, Enigma shall provide the Client with a draft Sales Form as well as other relevant information including the requested services, goods, and deliverables;
        </p>
        
        <p className="mb-2">
          <strong>C)</strong> Next, the Client and Enigma will discuss the draft Sales Form (or similar) in good faith and with a view to jointly executing corresponding agreements, including any required revisions where required; and
        </p>
        
        <p className="mb-2">
          <strong>D)</strong> Lastly, the executed Sales Form(s), with any corresponding quotes or other documents to be included as an appendix, shall form an agreement and the Parties shall be bound by its terms.
        </p>
      </div>
      ...
      <h4 className="mb-3">3) OBLIGATIONS</h4>
      <p className="mb-3">
        3.1) Commencing on the Effective Date, the Parties agree that:
      </p>
      <ul className="mb-3 pl-4">
        <li className="mb-2">Enigma shall perform the Services in a timely and professional manner and in accordance with generally recognized industry standards for similar services;</li>
        <li className="mb-2">Enigma shall use commercially reasonable endeavours to meet any performance timelines specified under a Sales Forms but any such timelines shall be estimates only and time shall not be of the essence for the performance of the Services;</li>
        <li className="mb-2">In the event either Party identifies any non-conformity with the Services, said Party shall promptly notify the other Party of such and the non-conformity shall be rectified within a reasonable time frame from the date the notice is received;</li>
        <li className="mb-3">The Parties will comply with all applicable laws, statutes, regulations from time to time.</li>
      </ul>

      <p className="mb-3">3.2) Each Party acknowledges and agrees that they each shall:</p>
      <ul className="mb-3 pl-4">
        <li className="mb-2">Co-operate with the other Party in all matters relating to the Services;</li>
        <li className="mb-3">Appoint a designated primary representative who manages any escalation of issues arising;</li>
      </ul>

      <p className="mb-3">3.3) The Client shall:</p>
      <ul className="mb-3 pl-4">
        <li className="mb-2">Abide by the matters set out in the Schedules, including those matters relating to prohibited and restricted uses.</li>
        <li className="mb-2">Comply with the Third-Party Licences obligations set out in clause 5;</li>
        <li className="mb-2">Provide full, precise and accurate instructions and information to Enigma;</li>
        <li className="mb-2">Ensure that its equipment is in proper working order and complies with all applicable standards and approvals for such Services contemplated hereunder;</li>
        <li className="mb-2">In relation to Deliverables, be required to sign a certificate of client satisfaction after each Deliverable has been delivered and has been completed;</li>
        <li className="mb-2">Provide Enigma with adequate access (as reasonably requested) to appropriate members of staff and equipment in order to perform the Services;</li>
        <li className="mb-3">Provide such information, documentation and data in a timely manner as may be reasonably requested in order to perform the Services;</li>
      </ul>
      ...
      <p className="mb-4">
        ...
        <ul className="mt-2 pl-4">
          <li className="mb-2">Each individual with whom we deal is duly authorised and empowered to bind you;</li>
          <li className="mb-2">You are a company duly incorporated and in good standing in your jurisdiction;</li>
          <li className="mb-4">You are not a "consumer" and shall not claim any consumer rights.</li>
        </ul>
      </p>

      <h4 className="mb-3">4) FEES, EXPENSES AND PAYMENTS</h4>
      <p className="mb-3">
      ...
      <ul className="mb-3 pl-4">
        <li className="mb-2">Signing of the relevant agreement, such as a commencement payment, advance or deposit, if applicable;</li>
        <li className="mb-2">Acceptance of each stage of the Deliverables in accordance with the provisions of Schedule 1;</li>
        <li className="mb-2">Commencement and/or completion of a Service or a Milestone;</li>
        <li className="mb-2">Delivery of Goods;</li>
        <li className="mb-3">Under the provisions of a Sales Forms (including the meeting of any specified Milestone, where applicable), as the case may be.</li>
      </ul>
      ...
      <ul className="mb-3 pl-4">
        <li className="mb-2">Where advance payments are the first such payment under a particular Sales Form, Enigma shall invoice the Client, and the Client shall pay Enigma in advance of work commencing, with such payment falling due within five (5) days from the signing of that Sales Form;</li>
        <li className="mb-2">Where a deposit is required, the deposit shall be non-refundable unless Enigma fails to provide the first Deliverable and is wholly at fault for such failure;</li>
        <li className="mb-3">All advance payments, if applicable, must be paid in cleared funds within five (5) days of the payment profile set out within the relevant Sales Form.</li>
      </ul>
      ...
      <h4 className="mb-3">5) THIRD-PARTY LICENCES</h4>
      <p className="mb-3">
      ...
      <p className="mb-3">5.2) The Client, in relation to the Third-Party Licences, shall:</p>
      <ul className="mb-4 pl-4">
        <li className="mb-2">Execute and comply with additional agreements or terms in relation to such Third-Party Licences, whether direct or indirect, including any applicable end user licence agreements (or similar terms);</li>
        <li className="mb-2">Remain liable for all payments owed to Enigma and until the expiry of any applicable Third-Party Licence payments or terms;</li>
        <li className="mb-2">Be bound by the terms, conditions, and notice periods of such Third-Party Licences, copies of which shall be provided by Enigma upon request or as necessary.</li>
      </ul>
      ...
      <h4 className="mb-3">6) TERM AND TERMINATION</h4>
      <p className="mb-3">
      ...
      <ul className="mb-3 pl-4">
        <li className="mb-2">They are terminated in accordance with the provisions of these Standard Terms;</li>
        <li className="mb-2">The Client ceases to use all products or services of Enigma, and such access has been removed or disabled by Enigma;</li>
        <li className="mb-2">Any Third-Party Licence term ceases to continue, if so applicable;</li>
        <li className="mb-3">There have been no active Sales Forms in effect for a continuous period of ninety (90) days, with such period of time being the "Term".</li>
      </ul>
      ...
      <ul className="mb-3 pl-4">
        <li className="mb-2">The non-terminating Party is in material or persistent breach of any of the provisions of the Standard Terms or any Sales Forms, which, if remediable, is not remedied within thirty (30) days, or such alternative period as may be agreed between the Parties, following the receipt of such written notice;</li>
        <li className="mb-2">The non-terminating Party is unable to pay its debts (within the meaning of section 123(1) of the Insolvency Act 1986) or an order is made or a resolution passed for its liquidation, winding-up or dissolution (otherwise than for the purpose of a solvent amalgamation or reconstruction) or an administrative or other receiver, manager, trustee, liquidator, administrator or similar officer is appointed over it or all or any substantial part of its assets or takes formal steps towards making any kind of composition, compromise or arrangement involving it and any of its creditors, or anything analogous to the foregoing shall occur in any jurisdiction;</li>
        <li className="mb-3">The other Party is dissolved, or suspends or ceases, or threatens to suspend or cease, carrying on all or a substantial part of its business.</li>
      </ul>
      ...
      <p className="mb-4">
        ...
        <ul className="mt-2 pl-4">
          <li className="mb-2">The Client has breached these Standard Terms or a Sales Form, including those relating to a Third-Party Licence;</li>
          <li className="mb-2">Such action is requested by the Client or required by law;</li>
          <li className="mb-4">There is a material change, discontinuance, or technical or security issue affecting the Services.</li>
        </ul>
      </p>
      ...
      <ul className="mb-3 pl-4">
        <li className="mb-2">They are a company duly organized, validly existing and in good standing under the laws of its incorporation and it has full power and authority to enter into the Standard Terms and each Sales Form, and to perform each and every covenant and agreement herein and therein contained;</li>
        <li className="mb-2">The Standard Terms have been, and each Sales Form will be, duly authorized, executed and delivered by it and constitutes a valid, binding and legally enforceable agreement of it;</li>
        <li className="mb-2">The execution and delivery of each Sales Form, the commencement of these Standard Terms, and the performance of the covenants and agreements herein and therein contained, are not, in any manner or to any extent, limited or restricted by, and are not in conflict with, any commercial arrangements, obligations, contract, agreement or instrument to which it is either bound or subject;</li>
        <li className="mb-2">The execution and delivery of the Standard Terms and each Sales Form and the performance of its covenants and agreements herein and therein contained shall comply in all respects with all applicable laws to which it or its business is subject;</li>
        <li className="mb-2">It owns or has the necessary rights to grant any licenses under the Standard Terms, and any Technology or Intellectual Property Rights (as defined in Schedule 2) licensed under these Standard Terms does not infringe upon the rights of or misappropriate the confidential information, Intellectual Property Rights or trade secrets of any third-party, where applicable, all within a territory; each Party hereby waives, and has caused each contributing individual to waive, moral rights arising from any such licensed Technology or Intellectual Property Rights;</li>
        <li className="mb-2">If applicable, each Party shall use commercially reasonable efforts through the use of industry standard virus protection software and other customary procedures to screen any software provided or made available by it hereunder to avoid introducing any virus that disrupts the operations of the other Party;</li>
        <li className="mb-2">Neither the entry into or performance by it, nor any payment contemplated by, these Standard Terms does or will conflict with any court order or agreement to which it is a party or with its constitutional documents;</li>
        <li className="mb-3">In fulfilling its obligations pursuant to the Standard Terms, it will use a degree of skill and care and diligence reasonably to be expected of a competent business in its industry, and to recognized commercial practices and standards, in compliance with the relevant laws and applicable regulations.</li>
      </ul>
      ...
      <h4 className="mb-3">8) LIABILITY</h4>
      <p className="mb-3">
      ...
      <p className="mb-4">
        ...
        <ul className="mt-2 pl-4">
          <li className="mb-2">Neither Party shall be liable to the other for any Consequential Loss, whether in contract, tort (including negligence), for breach of statutory duty, or otherwise, arising for: (i) loss of profits; (ii) loss of sales, business or opportunity; (iii) loss of agreements or contracts; (iv) replacement goods; (v) loss of or damage to goodwill; (vi) loss of technology rights or services; or (vii) any indirect or consequential loss;</li>
          <li className="mb-4">Enigma's total liability to the other, whether in contract, tort (including negligence), or otherwise, arising directly or indirectly under or in connection with these Standard Terms shall not exceed: (i) total Fees paid under the relevant Sales Form in the twelve (12) months preceding the claim, or (ii) actual direct loss proven up to GBP25,000 or USD30,000, whichever is the applicable functional currency.</li>
        </ul>
      </p>
      ...
      <h4 className="mb-3">9) FORCE MAJEURE</h4>
      <p className="mb-3">
      ...
      <p className="mb-4">
        ...
        <ul className="mt-2 pl-4">
          <li className="mb-2">Immediately telling the other Party in writing that an event of Force Majeure has occurred, the reasons for the delay and the likely duration of the delay;</li>
          <li className="mb-4">Using all reasonable endeavours to recommence the performance of its obligations in accordance with these Standard Terms and any affected Sales Forms as soon as possible and keeps the other Party informed as to progress and the estimated dates on which that Party will be able to recommence full performance of its obligations, the performance of the delayed Party's obligations will be suspended during the period that such circumstances of Force Majeure persist, that Party will be granted an extension of time for performance equal to the period of the delay.</li>
        </ul>
      </p>

      <h4 className="mb-3">10) ASSIGNMENT AND SUBCONTRACTING</h4>
      <p className="mb-3">
      ...
      <h4 className="mb-3">11) GENERAL</h4>
      <p className="mb-3">
      ...
      <h5 className="mb-3 font-semibold">No Partnership or Agency</h5>
      <p className="mb-3">
        ...
        <ul className="mt-2 pl-4">
          <li className="mb-2">Is intended to, or shall be deemed to, establish any partnership or joint venture between the Parties, or authorise any Party to make or enter into any commitments for or on behalf of any other;</li>
          <li className="mb-3">Shall be construed to create an exclusive relationship between the Client and Enigma. Additionally, Enigma retains the right to perform work for others during the Term, and the Client retains the right to cause work of the same or a different kind to be performed by its own personnel or other providers during the Term.</li>
        </ul>
      </p>
      ...
      <h5 className="mb-3 font-semibold">Entire Agreement and Counterparts</h5>
      <p className="mb-3">
      ...
      <div className="mt-12 pt-8 border-t border-gray-700">
        <h3 className="text-2xl font-bold text-light mb-6">SCHEDULE 2</h3>
        <h4 className="text-xl font-semibold text-light mb-6">CONFIDENTIAL INFORMATION, INTELLECTUAL PROPERTY, AND DATA PROTECTION</h4>
        
        <h5 className="text-lg font-semibold mb-3">1) INTERPRETATION</h5>
        <p className="mb-3">
        ...
        <h5 className="text-lg font-semibold mb-3">3) INTELLECTUAL PROPERTY</h5>
        <p className="mb-3">
        ...
        <h5 className="text-lg font-semibold mb-3">4) KNOWLEDGE CAPITAL</h5>
        <p className="mb-6">
        ...
        <h5 className="text-lg font-semibold mb-3">5) MISCELLANEOUS</h5>
        <p className="mb-3">
