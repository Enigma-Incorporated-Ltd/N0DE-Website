...
const BlogHomeThree = () => {
	...
	return (
		<>
			<style>{`
				.blog-card-home-three {
					transition: transform 0.3s ease;
				}
				.blog-card-home-three:hover {
					transform: translateY(-5px);
				}
				.blog-image-wrapper-three {
					position: relative;
					overflow: hidden;
					border-radius: 12px;
					margin-bottom: 1.5rem;
				}
				.blog-image-wrapper-three img {
					transition: transform 0.4s ease;
					width: 100%;
					height: 220px;
					object-fit: cover;
				}
				.blog-image-wrapper-three:hover img {
					transform: scale(1.08);
				}
				.blog-tag-link-three {
					transition: all 0.3s ease;
				}
				.blog-tag-link-three:hover {
					transform: translateY(-2px);
					color: var(--bs-primary) !important;
				}
				.blog-title-link-three {
					transition: all 0.3s ease;
				}
				.blog-title-link-three:hover {
					color: var(--bs-primary) !important;
					...
					<div className="container">
						<div className="row justify-content-center">
							<div className="col-md-10 col-lg-8 col-xl-6">
								<span className="d-block fw-medium text-light fs-20 mb-2" data-cue="fadeIn">
									Latest Blogs
								</span>
								...
								<div key={blog.uuid} className="col-md-6 col-lg-4 blog-card-home-three">
									...
									>
										<img
											...
											className="img-fluid"
											onError={(e) => {
												(e.target as HTMLImageElement).src = "assets/img/blog-img-4.png";
											}}
										/>
									</Link>
									<div className="d-flex align-items-center flex-wrap gap-3 mb-3">
										{tag && (
											<Link
												to={`/blog?tag=${tag}`}
												className="badge bg-primary-gradient text-white px-3 py-1 rounded-pill fs-12 fw-normal blog-tag-link-three text-decoration-none"
											>
												{tag}
											</Link>
										)}
										<span className="d-inline-flex align-items-center gap-2 fs-12 text-light text-opacity-50">
